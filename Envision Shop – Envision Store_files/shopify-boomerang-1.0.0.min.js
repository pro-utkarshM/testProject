  ...
  (o.d = (e, t) => {
                ...
                setImmediate: function (e, n, r, i) {
                  ...
                  (o = function () {
                    ...
                    t.requestIdleCallback
                      ? t.requestIdleCallback(o, { timeout: 1e3 })
                      : t.setImmediate
                      ? t.setImmediate(o)
                      : setTimeout(o, 10);
                },
    ...
    (function () {
      ...
      if (window.PerformanceObserver && window.PerformanceLongTaskTiming) {
        ...
        try {
          e.perfObserver.observe({ entryTypes: ["longtask"] });
        } catch (t) {
          e.isDone = !0;
        }
      } else e.isDone = !0;
    ...
    (e = o(935)),
    (t = { CLS: "cumulative_layout_shift_score", FID: "first_input_delay" }),
    (function () {
      (BOOMR = window.BOOMR || {}), (BOOMR.plugins = BOOMR.plugins || {});
      var n = {
        retries: 0,
    ...
    (function () {
      ...
      if (
        ...
        var t = {
          ...
          n = { prefetch: 1, preload: 2, prerender: 3, stylesheet: 4 },
          r = [
            "startTime",
            "redirectStart",
            "redirectEnd",
      ...
      function g(n, r) {
        ...
        if (!R || !R.length) return { resource_timing: {} };
        for (i = 0; i < R.length; i++) {
          (s = R[i]),
        ...
        return { resource_timing: a(o(_, e.splitAtPath), !0) };
      }
      function v(e) {
        var t = [];
