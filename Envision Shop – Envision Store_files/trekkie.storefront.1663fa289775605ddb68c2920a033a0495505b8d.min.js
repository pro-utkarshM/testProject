!(function () {
  var e = {
      ...
      8920: function (e, t, n) {
        ...
        function f(e) {
          return C(r.TrackingRegulationLimitations.GDPR_BLOCK_ALL) && e
            ? h()
              ? document.referrer
              : ""
            : null;
        ...
        function y() {
          return (
            C(r.TrackingRegulationLimitations.GDPR) ||
            C(r.TrackingRegulationLimitations.GDPR_BLOCK_ALL)
          );
        }
        function E() {
          const e = d();
        ...
        function T() {
          return (
            ...
            !!C(r.TrackingRegulationLimitations.CCPA) &&
            g()
          );
        }
        function P() {
          return (
            ...
            (!!i.validCookieDoesNotExist() ||
              (!1 !== m() &&
                (C(r.TrackingRegulationLimitations.CCPA_BLOCK_ALL)
                  ? d() !== r.TrackingRegulations.CCPA
                  : !C(r.TrackingRegulationLimitations.CCPA) ||
        ...
        const k = {
          ...
          setCCPAConsent: function (e, t) {
            ...
            return u.updateTrackingConsent({ ccpa_consent: e }, t, S());
          },
          getCCPAConsent: A,
        ...
        (t.metricsSchemaId = "trekkie_metrics/2.0"),
          ...
          (t.sendToBugsnag = function (e) {
            ...
            if (this.shouldSendToBugsnag()) {
              var n = "1663fa289775605ddb68c2920a033a0495505b8d",
                o = null,
                r = null,
                i = null;
              if (e.appConfig)
      ...
      7668: function (e, t, n) {
        ...
        (t.UniqueIdManager = c), (t.buildToken = u), (t.hexTime = p);
      },
      1102: function (e, t, n) {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 }),
            ...
            return (
              ...
              (e.prototype.logAssetContext = function (e) {
                ...
                s.addBatchEvent({
                  ...
                  payload: {
                    build_id: "1663fa289775605ddb68c2920a033a0495505b8d",
