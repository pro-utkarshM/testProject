!(function () {
  ...
  e(function (e, t) {
    ...
    function i(e, t) {
      ...
      try {
        for (
          var c, d = decodeURI(e).split("&")[Symbol.iterator]();
          !(a = (c = d.next()).done);
          a = !0
        ) {
          var s = c.value.split("="),
    ...
    function l(e, t) {
      ...
      var o = f({ referer: window.location.href }, r);
    ...
    var n,
      ...
      p = (function () {
        ...
        return (
          c(a, null, [{ key: "handleXhrOpen", value: function e() {} }]),
          c(
            a,
            [
              {
            ...
            [
              {
                ...
                value: function r(o) {
                  try {
                    ...
                    e.href = o.url;
                    var t = e.pathname ? e.pathname : o.url;
                    a.ADD_TO_CART_REGEX.test(t) &&
                      a._parsePayloadResponse(o, function (e) {
                        var t = Object.keys(e);
                        if (1 === t.length && "items" === t[0]) {
                          var n = e.items,
                            r = void 0;
                          try {
                            r = JSON.parse(o.body).items;
                          } catch (a) {
                            r = i(o.body, n.length);
                          }
                          s(n, r);
    ...
    (p.ADD_TO_CART_REGEX =
      ...
      (function () {
          ...
          if (
            ...
            if (t && (t.getAttribute("action") || t.getAttribute("href")))
              try {
                ...
                var a = h("cart"),
                  o = s(n.value);
                o.quantity = String(t.quantity ? t.quantity.value : 1);
                var i = f({ cartToken: a }, o),
                  c = f({ referer: window.location.href }, o);
                window.ShopifyAnalytics.lib.track("Added Product", i),
                  window.ShopifyAnalytics.lib.track(
                    "monorail://trekkie_storefront_track_added_product/1.1",
                    c,
                  );
        ...
        function i(e) {
          c((e = e || window.event).currentTarget);
        }
        function c(e) {
          try {
            var t = void 0,
            ...
            if (
              ...
              return;
            var a = s((window.ShopifyAnalytics.meta.selectedVariantId = r));
        ...
        function d(e, t) {
          ...
          try {
            for (
              ...
              var c = o.value,
                d = u(e, c);
              if (d) return { product: c, variant: d };
            }
          } catch (s) {
            (r = !0), (a = s);
          } finally {
        ...
        function n(e) {
          ...
          if (window.ShopifyAnalytics.meta.products) {
            var a = d(e, window.ShopifyAnalytics.meta.products);
            (t = a.product), (n = a.variant);
          } else
            window.ShopifyAnalytics.meta.product &&
              (n = u(e, (t = window.ShopifyAnalytics.meta.product)));
          return (
            t
              ? ((r = {
                  productId: t.id,
        ...
        r(window, "load", function () {
          for (var e = 0; e < document.forms.length; e++) {
            ...
            n && "payment_method" === n.value && r(document.body, "submit", o);
          }
        });
      })(),
      (n = XMLHttpRequest),
          ...
          (e.fetch = function () {
            ...
            return t
              ...
              .then(function (e) {
                ...
                try {
                  if (p.ADD_TO_CART_REGEX.test(n)) {
                    try {
                      var r = JSON.parse(o[1].body);
                      if (Object.keys(r).includes("items")) return i(e, r), e;
                    } catch (a) {}
                    c(e, o[1].body);
                  }
                } catch (a) {
