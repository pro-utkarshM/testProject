  ...
  var e = function (e) {
    ...
    P = e(function (e) {
      ...
      e.exports = function (e) {
        ...
        return e === undefined
          ...
          : null === e
          ? "Null"
          : "string" == typeof (r = s((t = Object(e)), i))
          ? r
          : o
          ? m(t)
    ...
    u = e(function (e) {
      e.exports = function (e, t) {
        ...
        if (t && "function" == typeof (r = e.toString) && !L((n = r.call(e))))
          return n;
        if ("function" == typeof (r = e.valueOf) && !L((n = r.call(e))))
          return n;
        if (!t && "function" == typeof (r = e.toString) && !L((n = r.call(e))))
          return n;
    ...
    M = e(function (e) {
      ...
      (B.inspectSource = function (e) {
        ...
        (e.exports = function (e, t, r, n) {
          ...
          i && (E(r, "name") || T(r, "name", t)),
            e[t] !== r &&
              (i && (E(r, o) || T(r, o, e[t] ? "" + e[t] : s.join(String(t)))),
              e === O
                ? (e[t] = r)
                : n
                ? e[t]
    ...
    U = e(function (e) {
      e.exports = n
        ...
        : function s(e, t) {
            p(e);
            for (var r, n = A(t), i = n.length, o = 0; o < i; )
              c.f(e, (r = n[o++]), t[r]);
            return e;
          };
    }),
    ...
    G = e(function (e) {
        ...
        s = function () {
          ...
          for (
            t.style.display = "none",
              ...
              e.write(
                n + "script" + i + "document.F=Object" + n + "/script" + i,
              ),
              e.close(),
              s = e.F;
            r--;
      ...
      e.exports =
        ...
        function a(e, t) {
          ...
          return (
            null !== e
              ? ((i[o] = p(e)), (r = new i()), (i[o] = null), (r[n] = e))
              : (r = s()),
            t === undefined ? r : U(r, t)
          );
        };
    ...
    V = e(function (e) {
      ...
      T(n, j("iterator"), function () {
        ...
        (e.exports = function (e, t, r) {
          (e.prototype = G(n, { next: o(1, r) })), z(e, t + " Iterator");
        });
    }),
    q = e(function (e) {
      e.exports = function (e) {
    ...
    W = e(function (e) {
      ...
      e.exports = function (e, t, i, r, n, o, s) {
        ...
        if (
          (v &&
            (c = H(v.call(new e()))) !== Object.prototype &&
            c.next &&
            (z(c, l, !0), R || E(c, g) || T(c, g, A)),
          d &&
            w &&
            w.name !== S &&
            ((h = !0),
          ...
          if (
            ((a = { values: d ? y : f(S), keys: o ? y : f(k), entries: m }), s)
          )
      ...
      (o && s) ||
        ...
        "process" == m(i)
          ...
          ? ((n = function (e) {
            ...
            O.addEventListener("message", h, !1))
          : (n =
              l in v("script")
                ? function (e) {
    ...
    ie = e(function (e) {
      ...
      e.exports = function () {
        ...
        if (l)
          ...
          new u(e).observe(r, { characterData: !0 }),
            (o = function () {
              r.data = t = !t;
            });
        } else if (f && f.resolve) {
                  ...
                  try {
                    n
                      ? (c || (2 == f._h && v(f), (f._h = 1)),
                        !0 === n
                          ? (t = u)
                          : (s && s.enter(), (t = n(u)), s && s.exit()),
                        t === e.promise
                          ? o(l("Promise-chain cycle"))
                          : (r = p(t))
                          ? r.call(t, i, o)
                          : i(t))
                      : o(u);
  ...
  !(function (e) {
        ...
        (e.fetch = function (i, o) {
          return new Promise(function (r, e) {
            ...
            (n.onload = function () {
              ...
              "responseType" in n && m.blob && (n.responseType = "blob"),
    ...
    (function (e) {
      ...
      function u(o, s, a) {
        ...
        return function c(e, t) {
          ...
          for (a.method = e, a.arg = t; ; ) {
            ...
            "throw" === i.type &&
              ((u = E), (a.method = "throw"), (a.arg = i.arg));
          }
        };
      }
      function l(e, t) {
        ...
        if ("throw" === n.type)
          return (t.method = "throw"), (t.arg = n.arg), (t.delegate = null), O;
        var i = n.arg;
        return i
          ? i.done
            ? ((t[e.resultName] = i.value),
              (t.next = e.nextLoc),
              "return" !== t.method && ((t.method = "next"), (t.arg = w)),
              (t.delegate = null),
              O)
            : i
          : ((t.method = "throw"),
      ...
      if (k) _ && (module.exports = k);
        ...
        (r.prototype = B.constructor = t),
          (t.constructor = r),
          (t[x] = r.displayName = "GeneratorFunction"),
          ...
          (k.mark = function (e) {
            return (
              Object.setPrototypeOf
                ...
                : ((e.__proto__ = t), x in e || (e[x] = "GeneratorFunction")),
          ...
          (d.prototype = {
            ...
            finish: function (e) {
              for (var t = this.tryEntries.length - 1; 0 <= t; --t) {
                ...
                if (r.finallyLoc === e)
                  return this.complete(r.completion, r.afterLoc), c(r), O;
              }
            },
            catch: function (e) {
              for (var t = this.tryEntries.length - 1; 0 <= t; --t) {
            ...
            delegateYield: function (e, t, r) {
              return (
                (this.delegate = { iterator: h(e), resultName: t, nextLoc: r }),
  ...
  var le = e(function (j, P) {
      !(function (i, l) {
        ...
        var e = "0.7.23",
                        ...
                        typeof (o = f[i]) === h && 0 < o.length
                          ? 2 == o.length
                            ...
                            ? typeof o[1] !== d || (o[1].exec && o[1].test)
                              ? (this[o[0]] = a ? a.replace(o[1], o[2]) : l)
                              : (this[o[0]] = a ? o[1].call(this, a, o[2]) : l)
                            : 4 == o.length &&
                              (this[o[0]] = a
          ...
          T = function (e, t) {
            if (
              ("object" == typeof e && ((t = e), (e = l)), !(this instanceof T))
            )
            ...
            return (
              (this.getBrowser = function () {
                var e = { name: l, version: l };
                return (
                  k.rgx.call(e, r, n.browser), (e.major = _.major(e.version)), e
                );
              }),
              (this.getCPU = function () {
                var e = { architecture: l };
                return k.rgx.call(e, r, n.cpu), e;
              }),
              (this.getDevice = function () {
                var e = { vendor: l, model: l, type: l };
        ...
        (T.VERSION = e),
          (T.BROWSER = { NAME: u, MAJOR: n, VERSION: p }),
          (T.CPU = { ARCHITECTURE: w }),
          (T.DEVICE = {
            MODEL: a,
            VENDOR: f,
            TYPE: c,
          ...
          (T.ENGINE = { NAME: u, VERSION: p }),
          (T.OS = { NAME: u, VERSION: p }),
          "object" !== t
            ? ("object" !== t && j.exports && (P = j.exports = T),
              (P.UAParser = T))
          ...
          return (
            r(i, [
              ...
              },
              {
                ...
                get: function n() {
                  return (
                    this.ua.getUA().includes("Android") &&
                    this.name.includes("Chrome")
                  );
                },
              },
              {
              ...
              },
              {
                ...
                get: function n() {
                  var e = this.ua.getOS(),
                    ...
                    r =
                      /Shopify Mobile|Shopify POS|Shopify Ping/.test(
                        this.userAgent,
    ...
    we = e(function (e, t) {
      ...
      function n(e, t) {
        ...
        document.cookie =
          f + "=" + e + "; expires=" + i.toGMTString() + "; path=/";
      }
      Object.defineProperty(t, "__esModule", { value: !0 });
      var i,
        o,
                  ...
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        if (
                          !0 ===
                          new pe.Browser({ userAgent: navigator.userAgent })
                            .isSafari
                        )
        ...
        a =
          ((o = y(
            regeneratorRuntime.mark(function p() {
              var t, r, n, i, o, s;
              return regeneratorRuntime.wrap(
                function a(e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      ...
                      case 10:
                        return (
                          (o = e.sent), (s = o.eligible), e.abrupt("return", s)
                        );
                      case 15:
                        return (
                          (e.prev = 15),
