  ...
  (n.amdO = {}),
    (() => {
          ...
          e.Shopify.evids ||
            ...
            (e.Shopify.evids = (e, t) =>
              (function (e, t) {
                if (
                  !le[e] ||
                  ("trekkie" !== (null == t ? void 0 : t.analyticsFramework) &&
      ...
      const be = "production",
        we = "0.0.349",
        ge = "modern",
        ve = "ab9016a5w09126b9fp260b266fmecbb582e",
        ye = {
      ...
      function Ee(e, t) {
        return { schemaId: ye[e], payload: t };
      }
      const _e = {
        randomUUID:
      ...
      const Re = {},
        Pe = {
          ...
          "page:session": {
            start: { name: "start", params: Re },
            end: { name: "page:unload", params: Re },
          },
          completed: {
            start: { name: "start", params: Re },
            end: { name: "pixels:resolved", params: Re },
          },
        };
      function Oe(e, t = Re) {
        ...
        Fe = (e, t) => {
          try {
              ...
              try {
                l = (function (e, t) {
                  ...
                  const o = {
                    ...
                    columnNumber: "1",
                    method: t.context,
                    file: "https://cdn.shopify.com/bab9016a5w09126b9fp260b266fmecbb582em.js",
                  };
            ...
            fetch(u, {
              ...
              body: JSON.stringify({
                payloadVersion: 5,
                notifier: { name: "web-pixel-manager", version: we, url: "-" },
                events: [
                  {
                    exceptions: [l],
                    context: s.context,
      ...
      function ze(e, t = !1) {
        const n = {
          ...
          metadata: { event_created_at_ms: We() },
        };
      ...
      function Xe({ skipXhr: e } = { skipXhr: !1 }) {
        if (((qe = void 0), 0 === Ye.length)) return;
        const t = [...Ye];
        (Ye.length = 0),
          (function (e, t) {
            if (0 === e.length) return !1;
            const n = { metadata: { event_sent_at_ms: We() }, events: e };
            !(function (e, t) {
      ...
      class Qe {
        constructor({
          ...
          (this.channelSubscribers = new Map()),
            ...
            (this.replayQueue = new Je(e, t)),
            (this.eligibility = null != o ? o : Ze);
        }
        publish(e, t, n = {}) {
          var o;
        ...
        subscribe(e, t, n = {}) {
          ...
          return (
            ...
            this.replayQueue.forEach(({ name: o, payload: r, options: i }) => {
              this.eligibility(i, n, e) &&
                (e === o ||
      ...
      const it = ["checkout_completed", "checkout_started"],
        at = (e, t, n) => {
          const { pixelRuntimeConfig: o } = t || {},
            { apiClientId: r, restrictions: i } = o || {},
            { allowedEvents: a, disallowedEvents: s } = i || {},
            { sendTo: c } = e || {},
            l = c && String(c) === String(r),
            u = e.sendTo && !l,
            d = !a || a.includes(n),
            f = s && s.includes(n);
        ...
        return void 0 === e || n(e)
          ? {
              isValid: (function e(o) {
                ...
                return (
                  r ||
                    (t = `${o} must be one of the following types: ${ct.join(
                      ", ",
                    )}`),
                  r
                );
          ...
          const n = (t) => {
            R(),
              (function (e) {
                const t = e.detail;
                return (
                  !0 === (null == t ? void 0 : t.firstPartyMarketingAllowed) &&
                  !0 === (null == t ? void 0 : t.thirdPartyMarketingAllowed) &&
                  !0 === (null == t ? void 0 : t.analyticsAllowed)
                );
              })(t) &&
                (document.removeEventListener(o.CONSENT_COLLECTED, n), e(!0));
          };
      ...
      function xt(e) {
        const t = new Qe({
          ...
          n = new Qe({ bufferSize: 1e3, subscribeAllKey: Et, eligibility: at }),
          o = new Qe({
            bufferSize: 1e3,
            replayKeep: "newest",
            subscribeAllKey: _t,
        ...
        return {
          publish(n, o, i) {
            ...
            return (
              ...
              He("eventPublish", {
                ...
                eventType: "standard",
                extensionId:
                  null == i || null === (a = i.extension) || void 0 === a
                    ? void 0
                    : a.extensionId,
                extensionAppId:
                  null == i || null === (s = i.extension) || void 0 === s
                    ? void 0
                    : s.appId,
                extensionType:
                  null == i || null === (c = i.extension) || void 0 === c
                    ? void 0
                    : c.type,
          ...
          publishCustomEvent(t, o, r) {
            ...
            return (
              He("eventPublish", {
                ...
                eventType: "custom",
                extensionId:
                  null == r || null === (i = r.extension) || void 0 === i
                    ? void 0
                    : i.extensionId,
                extensionAppId:
                  null == r || null === (a = r.extension) || void 0 === a
                    ? void 0
                    : a.appId,
                extensionType:
                  null == r || null === (s = r.extension) || void 0 === s
                    ? void 0
                    : s.type,
                eventId: l.id,
              }),
          ...
          subscribe(e, r, i = {}) {
            const a = (e) => {
              var t;
              const n =
                i.schemaVersion || i.pixelRuntimeConfig.eventPayloadVersion;
              r.call(e, e);
              const o = nt(e.name);
              He("subscriberEventEmit", {
                ...
                pixelConfiguration:
                  null === (t = i.pixelRuntimeConfig) || void 0 === t
                    ? void 0
                    : t.configuration,
            ...
            return e === Et
              ...
              : e === yt || ot(e)
              ? t.subscribe(e, a, i)
              : he("web_pixels_dom_analytics") && (e === _t || rt(e))
              ? o.subscribe(e, a, i)
              : n.subscribe(e, a, i);
          },
        };
      ...
      const At = ["31014027265", "28638674945"];
      const Tt = Symbol.for("RemoteUi::Retain"),
        St = Symbol.for("RemoteUi::Release"),
        kt = Symbol.for("RemoteUi::RetainedBy");
      class Nt {
        constructor() {
          this.memoryManaged = new Set();
        }
        add(e) {
          this.memoryManaged.add(e), e[kt].add(this), e[Tt]();
        }
        release() {
          for (const e of this.memoryManaged) e[kt].delete(this), e[St]();
          this.memoryManaged.clear();
        }
      }
      function It(e) {
        return Boolean(e && e[Tt] && e[St]);
      }
      function Rt(e, { deep: t = !0 } = {}) {
        const n = It(e);
        if ((n && e[Tt](), t)) {
          if (Array.isArray(e))
            return e.reduce((e, n) => Rt(n, { deep: t }) || e, n);
        ...
        return {
          encode: function o(r) {
            ...
            if ("function" == typeof r) {
              ...
              const o = e.uuid();
              return t.set(r, o), n.set(o, r), [{ [Pt]: o }];
            }
            return [r];
          },
          decode: r,
          ...
          if ("object" == typeof t) {
            ...
            if (Pt in t) {
              ...
              Object.defineProperties(u, {
                [St]: { value: s, writable: !1 },
                [Tt]: { value: c, writable: !1 },
                [kt]: { value: l, writable: !1 },
              });
      ...
      async function jt({
        ...
        const c = (function (
            e,
            { uuid: t = Lt, createEncoder: n = Ot, callable: o } = {},
          ) {
            let r = !1,
              i = e;
            const a = new Map(),
                ...
                switch (t[0]) {
                  ...
                  case 0: {
                    ...
                    try {
                      ...
                      throw (u(1, [o, { name: e, message: t, stack: r }]), n);
                    } finally {
                      e.release();
                    }
                    break;
                  ...
                  case 5: {
                    ...
                    try {
                      ...
                      const { name: t, message: o, stack: r } = n;
                      throw (u(6, [e, { name: t, message: o, stack: r }]), n);
                    }
                    break;
                  }
                }
        ...
        if (ve !== f.hashVersion) {
          const t = new Error(
            `The main bundle hash (${ve}) does not match the sandbox hash (${f.hashVersion})`,
          );
          Fe(t, {
            severity: "warning",
            pixelId: e.id,
        ...
        if ("error" === f.status)
          throw (
            ...
            new Error(
              `The creation of Web Pixel id "${e.id}" failed: ${JSON.stringify(
                f.error,
                null,
                2,
              )}`,
          ...
          const r = (e) => {
            try {
              ...
              Fe(n, {
                ...
                unhandled: !1,
                options: { sampleRate: o.sampleRate || 50 },
              });
            }
          };
      ...
      const Ft = (function () {
        ...
        try {
              ...
              init(n) {
                ...
                try {
                  ...
                  const e = a.map((e) => {
                    ...
                    return (
                      ...
                      (async function ({
                        ...
                        switch (
                          (e.restrictions ||
                            (e.restrictions = (function (e, t) {
                              if (!e) return {};
                              const n = (function (e) {
                                return At.includes(String(e));
                              })(e);
                          ...
                          await Promise.all([
                            ...
                            (d =
                              null === (s = e.restrictions) || void 0 === s
                                ? void 0
                                : s.preventLoadingBeforeEvent),
                            new Promise((e, t) => {
                              void 0 === d
                                ? e(!0)
                                : u(d, () => {
                        ...
                        const f = vt(e),
                          ...
                          { measurement: h } = Oe("pixel:register", {
                            pixelId: p,
                            source: m,
                          }),
                          b =
                  ...
                  Promise.all(e)
                    .then(() => {
                      return (
                        ((e = f).payload.isCompleted = "true"),
                        void (e.payload.runTimeDuration =
                          null === (t = Oe("completed")) ||
                          void 0 === t ||
                        ...
                        visitor: (e, t) =>
                          (function (e, t, n) {
                            ...
                            if (!o.valid)
                              throw new Error(
                                o.error ||
                                  "Invalid input payload to visitorApi",
                              );
                            const r = { ...e, ...t, ...n };
                            return (
                              ht()
                  ...
                  return (
                    ...
                    self.console && console.error(v),
                    (b.payload.status = "failed"),
                    (b.payload.errorMsg = null == v ? void 0 : v.message),
                    ze(b),
          ...
          return (
            r instanceof Be ||
              Fe(r, { context: "refactor/createWebPixelsManager" }),
            self.console && console.error(r),
            (n.payload.status = "manager-create-error"),
            (n.payload.errorMsg = null == r ? void 0 : r.message),
            ze(n, !0),
            { init: () => o }
          );
        }
      })();
      self.webPixelsManager = Ft;
    })();
})();
