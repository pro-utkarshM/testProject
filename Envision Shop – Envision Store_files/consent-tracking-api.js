!(function () {
  ...
  !(function (n) {
    (n.TRACKING_ACCEPTED = "trackingConsentAccepted"),
      ...
      (n.FIRST_PARTY_MARKETING_ACCEPTED = "firstPartyMarketingConsentAccepted"),
      ...
      (n.FIRST_PARTY_MARKETING_DECLINED = "firstPartyMarketingConsentDeclined"),
      (n.THIRD_PARTY_MARKETING_DECLINED = "thirdPartyMarketingConsentDeclined"),
  ...
  !(function (n) {
    ...
    (function (n) {
      (n.PREFERENCES = "p"),
        (n.ANALYTICS = "a"),
        (n.FIRST_PARTY_MARKETING = "m"),
        (n.THIRD_PARTY_MARKETING = "t");
    })(o || (o = {})),
    (function (n) {
      (n.GDPR = "GDPR"),
        (n.GDPR_BLOCK_ALL = "GDPR_BLOCK_ALL"),
        (n.CCPA = "CCPA");
    })(i || (i = {})),
    (function (n) {
      (n.MARKETING = "m"),
    ...
    if (
      ...
      !(function (n) {
        ...
        return !(function (n, t) {
          ...
          Object.keys(n).filter((n) => "region" !== n),
          u,
        );
      })(n)
    )
  ...
  function T(n, t) {
    ...
    !(function (n, t, e, r) {
      ...
      (o += "; path=/"),
        (o += "; domain=".concat(t)),
        (o += "; expires=".concat(
          new Date(new Date().getTime() + e).toUTCString(),
        )),
        (o += "; secure"),
        (document.cookie = o),
        (a[n] = r);
    })("_tracking_consent", n.rootDomain, 31536e6, E),
      t(null);
  }
  function R() {
    try {
  ...
  const O = { "": [], GDPR: [i.GDPR, i.GDPR_BLOCK_ALL], CCPA: [i.CCPA] };
  function w(n, t) {
  ...
  function m(t) {
    const e = t[o.FIRST_PARTY_MARKETING],
      ...
      c = t[o.PREFERENCES];
    !0 === e
      ? w(n.FIRST_PARTY_MARKETING_ACCEPTED)
      : !1 === e && w(n.FIRST_PARTY_MARKETING_DECLINED),
      !0 === r
        ? w(n.THIRD_PARTY_MARKETING_ACCEPTED)
        : !1 === r && w(n.THIRD_PARTY_MARKETING_DECLINED),
      !0 === i ? w(n.ANALYTICS_ACCEPTED) : !1 === i && w(n.ANALYTICS_DECLINED),
      !0 === c
        ? w(n.PREFERENCES_ACCEPTED)
        : !1 === c && w(n.PREFERENCES_DECLINED);
    const s = (function (n) {
      return {
    ...
    const u = [i, c, e, r];
    u.every((n) => !0 === n) && w(n.TRACKING_ACCEPTED),
      u.every((n) => !1 === n) && w(n.TRACKING_DECLINED);
  }
  function G(n, t) {
    const e = new XMLHttpRequest(),
      r = JSON.stringify(n);
    e.open("POST", "/set_tracking_consent.json", !0),
  ...
  function b() {
    ...
    const n = N();
    return n[c.MARKETING] === e.ACCEPTED && n[c.ANALYTICS] === e.ACCEPTED
      ? t.ACCEPTED
      : n[c.MARKETING] === e.DECLINED || n[c.ANALYTICS] === e.DECLINED
      ? t.DECLINED
      : t.NO_INTERACTION;
  }
  function M() {
  ...
  function F() {
    ...
    const n = N();
    if (n[c.MARKETING] === e.ACCEPTED && n[c.ANALYTICS] === e.ACCEPTED)
      return !0;
    if (n[c.MARKETING] === e.DECLINED || n[c.ANALYTICS] === e.DECLINED)
      return !1;
    return M() !== r.GDPR;
  }
  function j() {
  ...
  function H() {
    return !1 === V()
      ? t.DECLINED
      : ((n = P()),
        _() ? t.NO_VALUE : n === e.NO_VALUE ? t.NO_INTERACTION : d(n));
    var n;
  }
  const q = {
    ...
    setTrackingConsent: function (n, t) {
      if (_()) {
        ...
        return console.warn(n), t({ error: n });
      }
      if (
        ((function (n) {
          ...
          if ("object" == typeof n) {
            ...
            for (const n of t)
              if (!e.includes(n))
                throw TypeError(
                  "The submitted consent object should only contain the following keys: ".concat(
                    e.join(", "),
                    ".",
                  ),
                );
      ...
      if ("object" == typeof n) {
        ...
        return G(
          A(
            A({ granular_consent: n }, null !== e && { referrer: e }),
    ...
    setCCPAConsent: function (n, t) {
      ...
      return G({ ccpa_consent: n }, t);
    },
    getCCPAConsent: H,
    GPCSignal: V,
    shouldShowCCPABanner: function () {
      return (
        M() === r.CCPA && k().limit.includes(i.CCPA) && H() === t.NO_INTERACTION
      );
    },
    ...
    shouldShowBanner: function () {
      return (
        (function () {
          const n = g();
          return (
            !!n && "boolean" == typeof n.display_banner && n.display_banner
          );
        })() &&
        I(c.ANALYTICS) === e.NO_VALUE &&
        I(c.MARKETING) === e.NO_VALUE &&
        I(c.PREFERENCES) === e.NO_VALUE
      );
    },
  ...
  function x(n, t, e) {
    try {
      ...
      !(function (n) {
        ...
        shopId:
          X() ||
          (null === (r = window.Shopify) || void 0 === r ? void 0 : r.shop),
        notes: e,
      });
    } catch (n) {}
  }
  ...
  function Q(n, t) {
    return "object" == typeof n && n.headlessStorefront
      ? T(n, t)
      : q.setTrackingConsent(n, t);
  }
  function W() {
  ...
  function Tn() {
    q.getCCPAConsentValue() != e.DECLINED &&
      !1 === q.GPCSignal() &&
      rn(!1, () => !1);
    return {
  ...
  (window.Shopify = window.Shopify ? window.Shopify : {}),
    (window.Shopify.customerPrivacy = window.Shopify.trackingConsent = Tn());
})();
