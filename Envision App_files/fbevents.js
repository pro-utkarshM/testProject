            ...
            h(a, [
              {
                ...
                value: function (a, b, c) {
                  ...
                  this._configStore[b][a] = D[b] != null ? D[b](c) : c;
                },
              },
              {
                key: "setExperimental",
              ...
              },
              {
                key: "get",
                value: function (a, b) {
                  return this._configStore[b][a != null ? a : C];
                },
              },
              {
            ...
            h(d, [
              ...
              },
              {
                ...
                value: function (a) {
                  a === "revoke"
                    ...
                    : I({ action: a, type: "INVALID_CONSENT_ACTION" });
                  return this;
                },
              },
              {
                ...
                value: function (b, c) {
                  ...
                  if (
                    ...
                    I({ pixelID: b, type: "PIXEL_NOT_INITIALIZED" });
                    return;
                  }
              ...
              },
              {
                ...
                value: function (a) {
                  ...
                  a =
                    ...
                    E(a.userDataFormFields).length > 0;
                  return b || a;
                },
              },
              {
              ...
              },
              {
                ...
                value: function (a) {
                  ...
                  else I({ method: b, type: "INVALID_FBQ_METHOD" });
                },
              },
              {
              ...
              },
              {
                ...
                value: function (a) {
                  ...
                  if (
                    ...
                    G(this.fbq.pendingConfigs, function (b) {
                      return b === a;
                    }) === !1
                  ) {
                    var b = j.href,
          ...
          function A(a) {
            switch (a.type) {
              ...
              case "UNVERIFIED_EVENT":
                c = a.eventName;
                return (
                  "You are attempting to send an unverified event '" +
                  c +
      ...
      return (function (g, h, j, k) {
        ...
        (function () {
          ...
          var r = f.getFbeventsModules("SignalsFBEventsSendEventEvent"),
            ...
            u = f.getFbeventsModules("SignalsFBEventsProcessCCRulesEvent");
          b = f.getFbeventsModules("SignalsFBEventsUtils");
          var v = b.some,
            w = b.each,
            x = b.keys;
          ...
          function A(b) {
            ...
            c = c != null ? a({}, c) : null;
            var p = j.href;
            Object.prototype.hasOwnProperty.call(b, "documentLink")
              ? (p = n)
              : (b.documentLink = p);
            n = h.referrer;
            Object.prototype.hasOwnProperty.call(b, "referrerLink")
              ? (n = o)
              : (b.referrerLink = n);
            o = new m(l);
            o.append("id", k);
            ...
            if (
              c != null &&
              "_filteredParams" in c &&
              c._filteredParams != null &&
              i(c._filteredParams) === "object"
            ) {
              b = c._filteredParams;
              l = b.unwantedParams;
          ...
          function B(b) {
            ...
            var f = u.trigger(A(b), b.customData);
            f != null &&
              w(f, function (a) {
                a != null &&
                  w(x(a), function (c) {
                ...
                for (
                  ...
                  if (!k()(c, t)) {
                    ...
                    for (t = [{ element: t, workingNode: u }]; t.length; ) {
                      ...
                      for (
                        p = j()(n.querySelectorAll("[itemprop]")).reverse();
                        p.length;
                ...
                return (
                  ...
                  i()(
                    [null != b ? { key: "title", value: b } : null].concat(
                      m(
                        l()(
                          j()(g.querySelectorAll("meta[name]")),
                          function (a) {
                  ...
                  for (
                    ...
                    if (!o()(c, q)) {
                      ...
                      for (q = [{ element: q, workingNode: s }]; q.length; ) {
                        ...
                        s["@type"] = f;
                        for (
                          f = n()(v.querySelectorAll("[property]")).reverse();
                          f.length;
      ...
      return (function (a, b, c, d) {
        ...
        (function () {
            ...
            switch (a) {
              ...
              case "openbridge":
                ...
                G !== null &&
                  ...
                  typeof G === "string" &&
                  typeof H === "string" &&
                  (W.callMethod(["optIn", G, "OpenBridge"]),
                  W.pluginConfig.set(G, "openbridge", {
              ...
              case "trackSingleOnly":
                ...
                break;
              default:
                var O = W.pluginConfig.getWithGlobalFallback(
                    null,
                    "dataProcessingOptions",
                  ),
          ...
          function Z(a, b, c) {
            ...
            if (S.call(U, d)) {
              b != null && D(U[d].userData)
                ? ((U[d].userData = e ? b || {} : {}), X.loadPlugin("identity"))
                : N({ pixelID: d, type: "DUPLICATE_PIXEL_ID" });
              return;
            }
            a = {
          ...
          function ta(a, b, c, d) {
            ...
            e.append("coo", l);
            g = W.pluginConfig.getWithGlobalFallback(
              a ? a.id : null,
              "dataProcessingOptions",
            );
            if (g != null) {
